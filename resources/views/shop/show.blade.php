...
@section('content')
    ...
    <div class="grid sm:grid-cols-2 gap-2 pt-12 sm:pt-20 mx-auto w-4/5">
        ...
        <div>
            ...
            <a href="{{ route('add.to.cart',$product->id) }}" class="px-10 py-6 text-l uppercase text-white font-bold bg-blue-600 rounded-full w-full" role="button" aria-pressed="true">
                Add To Cart
            </a>
        </div>
    </div>
